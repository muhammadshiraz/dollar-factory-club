...
?>
<section class="poppins create-account xl:h-screen h-full">
    <div class="flex xl:flex-row flex-col h-full justify-center items-center">
        ...
        <div class="flex flex-col justify-center items-start w-full xl:px-44 px-8 xl:py-0 py-12">
          <div class="flex flex-col justify-between items-start gap-y-2 mb-8 w-full">
            ...
            <nav id="create-account-nav" class="create-account-nav flex flex-col justify-center items-start capitalize py-2 w-full text-lg mt-5">
              ...
              <img src="./assets/images/bottom-line.png" alt="Create Account" />
            </nav>
              ...
              <div id="tab1" class="tab-content w-full">
                <form class="w-full">
                  <div class="form-group flex flex-col justify-center items-start gap-y-3 mb-7">
                    <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" placeholder="Enter Phone Number" class="w-full py-3.5 px-3">
                  </div>
